...
void getReaderInfo(RFID_RADIO_HANDLE handle, char inf[40]) {
	...
	{
		sprintf(version, "%d.%d.%d.%d", macVersion.major, macVersion.minor, macVersion.maintenance, macVersion.release);
	}
